...
public class ListeOffreController implements Initializable{
    ...
    @FXML
    private JFXButton addOffreButton;
    @FXML
    ...
    @FXML
    public void ajouterOffreAction(ActionEvent event) throws IOException{
        Stage stage = new Stage();
        Parent root = FXMLLoader.load(getClass().getClassLoader().getResource("allforkids/GUI/AddOffre.fxml"));
        ...
        stage.initOwner(addOffreButton.getScene().getWindow());
    ...
    @FXML
    public void searchOffreAction(MouseEvent event) throws SQLException{
        String destination = searchOffre.getText();
        
        listeOffreTable.setItems(ots.searchOffreTransport(destination));
    }
